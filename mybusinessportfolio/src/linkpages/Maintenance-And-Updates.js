  ...
  return (
    <div className="container py-4">
      ...
      <section className="section">
        <p>
          Keep your website running like new with regular maintenance and on-demand updates.
          Whether you're looking to refresh content, fix bugs, or optimize performance, I’ve got you covered.
        </p>
      </section>

      <section className="section">
        <h3 className="subheader">What’s Included</h3>
        <ul className="text-start mx-auto" style={{ maxWidth: "800px", lineHeight: "1.8", fontSize: "1.1rem" }}>
      ...
      <section className="section">
        ...
        <p>
          Maintenance and update pricing is flexible and based on the scope of work.
          Small one-time edits can start as low as <strong>$25</strong>.
          For ongoing monthly maintenance, please <Link to="/contact" className="privacy-inline-link">contact me</Link> for a custom quote.
        </p>
      </section>
